export default function ServicesPage() {
  return (
    <main style={{ padding: "80px 24px", maxWidth: "1100px", margin: "0 auto" }}>
      ...
      <p style={{ fontSize: "18px", lineHeight: 1.7, marginBottom: "40px", color: "#555" }}>
        We provide structured, reliable ground transport solutions for tour operators
        and destination management companies delivering inbound travel programmes
      ...
      <div style={{ display: "grid", gap: "24px" }}>
        ...
        <div>
          <h3>Multi-Day Touring Transport</h3>
          <p>
            Reliable hotel-to-hotel touring operations across England, Scotland, Wales
            and Ireland, supporting structured itineraries.
          </p>
        </div>
        ...
        <div>
          <h3>Tour Operator Programmes</h3>
          <p>
