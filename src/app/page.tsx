          ...
          <div className="grid gap-16 md:grid-cols-2 md:items-start">
            ...
            <Reveal>
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                {[
                  { t: "Fixed‑Departure Series", d: "Season‑long touring support with reliable, repeatable operations." },
                  { t: "Multi‑Region UK Touring", d: "Balanced touring flows across England, Scotland & Wales." },
                  { t: "UK–Ireland Integration", d: "Seamless British Isles touring with cross‑country continuity." },
                  { t: "Large Group Coordination", d: "Professional management for high‑volume programmes." },
                ].map((x) => (
                  <div key={x.t} className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm hover:shadow-md transition">
      ...
      <section className="py-20 bg-cloud border-y border-black/5">
        <Container>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-4">
            {[
              { t: "United States", d: "Balanced pacing and smooth regional transitions." },
              { t: "India", d: "High‑energy itineraries with efficient timings." },
              { t: "China", d: "Precise scheduling and photo‑friendly pacing." },
              { t: "Europe", d: "Flexible routes and fast regional connections." },
            ].map((x) => (
              <Reveal key={x.t}>
